<template>
    <div class="shape-editor">
        <!-- Top bar: left (tool indicator), center (unit & grid), right (export) -->
        ...
        <canvas ref="canvas" @mousedown="handleMouseDown" @mousemove="handleMouseMove" @mouseup="handleMouseUp"
            @dblclick="handleDblClick" @mouseleave="handleMouseLeave" @contextmenu.prevent="handleContextMenu"></canvas>
        <ContextMenu :show="showContextMenu" :position="contextMenuPos" :activeTool="shapeType"
